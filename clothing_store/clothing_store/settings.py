...
SECRET_KEY = config('SECRET_KEY', default="django-insecure-73)@)thi95_5p67$u4)m&1lidxqzoc!iq&$d20lom7wo(nw-5=")
...
# CORS settings
CORS_ALLOW_ALL_ORIGINS = DEBUG  # 仅开发环境允许所有源
